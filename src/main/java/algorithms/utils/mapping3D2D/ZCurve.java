...
public class ZCurve {
    ...
    private static final int[] MORTON_TABLE_256 = {
    ...
    private static final int[] MORTON_TABLE_256_DECODE_X = {
     ...
     *
     * @param index morton code up to 48 bits
     * @return	array [x,y] .
     */
    public int[] decode(long index) {
