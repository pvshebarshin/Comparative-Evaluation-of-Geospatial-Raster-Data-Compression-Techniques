...
public final class BitMatrix implements Cloneable {
    ...
    public BitMatrix(int width, int height, int[] bits) {
        this.width = width;
        this.height = height;
        this.rowSize = (width + 31) / 32;
        this.bits = bits;
    ...
    private String buildToString(String setString, String unsetString) {
    ...
    public BitMatrix clone() {
        return new BitMatrix(width, height, bits.clone());
    }
